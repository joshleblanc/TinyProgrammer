...
WEB_STREAM_FPS = float(os.environ.get("WEB_STREAM_FPS", "1"))
WEB_STREAM_SCALE = float(os.environ.get("WEB_STREAM_SCALE", "1.0"))
WEB_STREAM_JPEG_QUALITY = int(os.environ.get("WEB_STREAM_JPEG_QUALITY", "85"))
